...
direct uploads for fully asynchronous user experience.
  ...
  gem.add_development_dependency "activesupport", RUBY_ENGINE == "jruby" ? "~> 7.0.0" : RUBY_VERSION >= "3.2" ? "~> 8.0" : "~> 7.0"

  # for ORM plugins
  gem.add_development_dependency "sequel"
  gem.add_development_dependency "activerecord", RUBY_ENGINE == "jruby" ? "~> 7.0.0" : RUBY_VERSION >= "3.2" ? "~> 8.0" : "~> 7.0"
