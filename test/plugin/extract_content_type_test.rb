...
class RealContentTypeTest < Minitest::Test
  ...
  test ":file returns nil when IO was not a file" do
    @uploader = uploader(:file)
  ...
  test ":mimemagic extracts content type of any IO" do
  ...
  test "extracting is not done with UploadedFiles" do
    @uploader = uploader(:file)
    uploaded_file = @uploader.upload(image)
